...
checked_role = False
while not checked_role:
    user_or_admin = input("You are a ... [student, admin]: ")
    if user_or_admin in ['student', 'admin']:
        break
    else:
        print("Please fill in either 'student' or 'admin'!\n")
...
if not has_nbgrader:
    print("The 'nbgrader' package was not installed (or not the right version; should be 0.6.0).\n"
...
if not has_data:
    print("You MUST download the data for this course, otherwise\n"
          ...
          "'download_niedu_data' to do so (you must have installed niedu already).")
